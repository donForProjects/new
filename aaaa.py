...
def main():
    ...
    layout = [[sg.Text('T.I.T.O. A.S.U.', size=(48 , 1),pad=(150,0), justification='center', font='Helvetica 20')],
              [sg.Image(filename='', key='image')],
              [sg.Button('Record', size=(22, 1), font='Helvetica 14', pad=(50,0)),
               sg.Button('Stop', "center", size=(22, 1), font='Any 14', pad= (50,0)),
               sg.Button('Exit', size=(22, 1), font='Helvetica 14', pad= (50,0)), ]]

    # create the window and show it without the plot
    window = sg.Window('T.I.T.O A.S.U',
                       layout, location=(300,300), size=(1080, 600))
